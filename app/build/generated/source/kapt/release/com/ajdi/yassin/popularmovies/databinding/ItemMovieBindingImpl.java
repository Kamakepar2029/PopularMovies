...
public class ItemMovieBindingImpl extends ItemMovieBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.movie == variableId) {
            setMovie((com.ajdi.yassin.popularmovies.data.local.model.Movie) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setMovie(@Nullable com.ajdi.yassin.popularmovies.data.local.model.Movie Movie) {
        this.mMovie = Movie;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        com.ajdi.yassin.popularmovies.data.local.model.Movie movie = mMovie;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            com.ajdi.yassin.popularmovies.ui.moviedetails.BindingAdapters.bindImage(this.imageMoviePoster, moviePosterPath, false);
